...
// Only "telegram" is active today. The DB column is untyped text, so legacy
// rows may contain "cli", "slack", or "discord". Extend this union when a new
// channel is implemented — do not widen it speculatively.
