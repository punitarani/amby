...
/**
 * @deprecated Use appendTaskTraceTerminalEvent instead.
 * Alias kept for backward compatibility with callers using the "run" naming.
 */
export const appendTaskRunTerminalEvent = appendTaskTraceTerminalEvent
